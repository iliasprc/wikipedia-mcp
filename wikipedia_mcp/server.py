...
def create_server(language: str = "en", enable_cache: bool = False) -> FastMCP:
    ...
    @server.tool()
    def extract_key_facts(title: str, topic_within_article: Optional[str] = None, count: int = 5) -> Dict:
    ...
    @server.tool()
    def get_related_topics(title: str, limit: int = 10) -> Dict:
    ...
    def summary_for_query_resource(title: str, query: str, max_length: int) -> Dict:
        """Get a summary of a Wikipedia article tailored to a specific query."""
    ...
    def summary_section_resource(title: str, section_title: str, max_length: int) -> Dict:
        """Get a summary of a specific section of a Wikipedia article."""
    ...
    def key_facts_resource(title: str, topic_within_article: str, count: int) -> Dict:
